  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white sticky top-0 z-10 border-b shadow-sm p-4 flex items-center gap-3">
        ...
        <h1 className="font-bold text-lg text-slate-800">Alerts Management</h1>
      </div>

      <div className="p-4 space-y-6">
        <section>
          <h2 className="text-sm font-bold text-slate-500 uppercase mb-3 px-1">Active Emergencies</h2>
          {activeAlerts.length === 0 ? (
             <div className="p-8 text-center bg-white rounded-xl border border-dashed border-slate-300">
               <CheckCircle2 className="w-8 h-8 text-green-500 mx-auto mb-2" />
               <p className="text-slate-500 font-medium">No active alerts. Good job!</p>
             </div>
          ) : (
                    ...
                    <div className="p-4 bg-red-50/50">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-red-700 text-sm">{new Date(alert.timestamp).toLocaleString()}</p>
                        </div>
                      </div>
                    </div>
                    <div className="p-4">
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-slate-600">Location: Sector 4</p>
                      </div>
