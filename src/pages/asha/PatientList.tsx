...
import { ArrowLeft, Search, Filter, ChevronRight, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-white sticky top-0 z-10 border-b shadow-sm">
        <div className="p-4 flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg text-slate-800">All Patients ({beneficiaries.length})</h1>
        </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">{patient.pregnancyStage.replace('_', ' ')}</p>
              </div>
            </div>
